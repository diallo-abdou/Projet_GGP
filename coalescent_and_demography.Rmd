...
## représentations
```{r}
hist(sim$pi,main=paste("Mean pi =",round(obs$mean_pi,2)," +/- ",round(1.96*obs$se_pi,2)),breaks=30)
hist(sim$Dtaj,main=paste("Mean Dtaj =",round(obs$mean_Dtaj,2),"+/-",round(1.96*obs$se_Dtaj,2)),breaks=30)
...
hist(tot_obs$mean_pi)
hist(tot_obs$mean_Dtaj)
hist(tot_obs$mean_coal_time)
